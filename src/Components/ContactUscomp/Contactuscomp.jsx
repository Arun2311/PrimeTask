...
const Contactuscomp = () => {
  ...
  return (
    ...
    <div className="container">
      <div className="left-column chnagear">
        <h2 className='have-question   ms-5'>Have Questions? Ask <br></br>us anything you want and <br></br> we’ll answer</h2>
        <p className='Send-mail ms-5'>Send a mail instead?</p>
        <a className='Hello-primalcare ms-5'>hello@primalcare.com</a>
      </div>
...
<div className='mt-5 pt-5 footchange'>
     <Footercomp/>
     </div>
    </div>
